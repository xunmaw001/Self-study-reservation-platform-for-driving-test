        ...
        <el-form
            ...
            <input id="jiaolianId" name="jiaolianId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="考试时间" prop="shangkeTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangkeTime" label="考试时间" prop="shangkeTime">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考试地点" prop="shangkeAddress">
                       <el-input v-model="ruleForm.shangkeAddress"
                                 placeholder="考试地点" clearable  :readonly="ro.shangkeAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.kaoshiContent"  label="考试内容" prop="kaoshiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaoshiContent" label="考试内容" prop="kaoshiContent">
