        ...
        <el-form
            ...
            <input id="jiaolianId" name="jiaolianId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="上课时间" prop="shangkeTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.shangkeTime"
                                type="datetime"
                                placeholder="上课时间"
                                :disabled="ro.shangkeTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangkeTime" label="上课时间" prop="shangkeTime">
                            <span v-html="ruleForm.shangkeTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="上课地点" prop="shangkeAddress">
                       <el-input v-model="ruleForm.shangkeAddress"
                                 placeholder="上课地点" clearable  :readonly="ro.shangkeAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.kechengContent"  label="课程内容" prop="kechengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kechengContent" label="课程内容" prop="kechengContent">
