        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '试卷状态' : ''">
                        <el-select v-model="searchForm.exampaperTypes" placeholder="请选择试卷状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jiaxiaozizhuxuexipingtai/upload/exampaperMuBan.xls"
                        >批量导入试卷表数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('exampaper','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('exampaper','考试') && scope.row.exampaperTypes==1" type="primary" icon="el-icon-edit" size="mini" @click="saveExamrecord(scope.row.id)">{{ contents.tableBtnFont == 1?'考试':'' }}</el-button>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '科目': "kemuTypes",
                     '试卷名称': "exampaperName",
                     '考试时长(分钟)': "exampaperDate",
                     '试卷总分数': "exampaperMyscore",
                     '试卷状态': "exampaperTypes",
            },
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'exampaper',//当前表表名,
                        sumColum : 'exampaper_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'exampaper_name',//分组字符串字段
                        // types : 'exampaper_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
