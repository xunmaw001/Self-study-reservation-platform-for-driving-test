    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教练工号" prop="jiaolianUuidNumber">
                        <el-input v-model="jiaolianForm.jiaolianUuidNumber"
                                  placeholder="教练工号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教练工号" prop="jiaolianUuidNumber">
                            <el-input v-model="ruleForm.jiaolianUuidNumber"
            ...
            <input id="jiaolianId" name="jiaolianId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="留言标题" prop="liuyanName">
                       <el-input v-model="ruleForm.liuyanName"
                                 placeholder="留言标题" clearable  :readonly="ro.liuyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="留言标题" prop="liuyanName">
                           <el-input v-model="ruleForm.liuyanName"
                                     placeholder="留言标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="liuyanText">
                        <el-input type="textarea"  :readonly="ro.liuyanText" v-model="ruleForm.liuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.liuyanText" label="留言内容" prop="liuyanText">
                            <span v-html="ruleForm.liuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role == "教练"){
                      ...
                      this.ro.jiaolianId= true;
                      this.ro.liuyanName= true;
                      this.ro.liuyanText= true;
                      this.ro.insertTime= true;
                      this.ro.replyText= false;
                      this.ro.updateTime= false;
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`liuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.liuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
