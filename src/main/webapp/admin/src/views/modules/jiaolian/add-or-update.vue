               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教练工号" prop="jiaolianUuidNumber">
                       <el-input v-model="ruleForm.jiaolianUuidNumber"
                                 placeholder="教练工号" clearable  :readonly="ro.jiaolianUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教练手机号" prop="jiaolianPhone">
                       <el-input v-model="ruleForm.jiaolianPhone"
                                 placeholder="教练手机号" clearable  :readonly="ro.jiaolianPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教练身份证号" prop="jiaolianIdNumber">
                       <el-input v-model="ruleForm.jiaolianIdNumber"
                                 placeholder="教练身份证号" clearable  :readonly="ro.jiaolianIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="jiaolianEmail">
                       <el-input v-model="ruleForm.jiaolianEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.jiaolianEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    jiaolianUuidNumber: false,
                    jiaolianName: false,
                    jiaolianPhone: false,
                    jiaolianIdNumber: false,
                    jiaolianPhoto: false,
                    sexTypes: false,
                    jiaolianEmail: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    jiaolianUuidNumber: new Date().getTime(),
                    jiaolianName: '',
                    jiaolianPhone: '',
                    jiaolianIdNumber: '',
                    jiaolianPhoto: '',
                ...
                rules: {
                   ...
                   jiaolianUuidNumber: [
                              { required: true, message: '教练工号不能为空', trigger: 'blur' },
                          ],
                   jiaolianName: [
                              { required: true, message: '教练姓名不能为空', trigger: 'blur' },
                          ],
                   jiaolianPhone: [
                              {  required: true, message: '教练手机号不能为空', trigger: 'blur' },
                   ...
                   jiaolianIdNumber: [
                              { required: true, message: '教练身份证号不能为空', trigger: 'blur' },
