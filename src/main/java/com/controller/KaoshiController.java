    ...
    */
    ...
    public R save(@RequestBody KaoshiEntity kaoshi, HttpServletRequest request){
        ...
        Wrapper<KaoshiEntity> queryWrapper = new EntityWrapper<KaoshiEntity>()
            ...
            .eq("shangke_address", kaoshi.getShangkeAddress())
            ;
...
//                            kaoshiEntity.setShangkeTime(sdf.parse(data.get(0)));          //考试时间 要改的
//                            kaoshiEntity.setShangkeAddress(data.get(0));                    //考试地点 要改的
