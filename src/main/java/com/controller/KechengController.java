    ...
    */
    ...
    public R save(@RequestBody KechengEntity kecheng, HttpServletRequest request){
        ...
        Wrapper<KechengEntity> queryWrapper = new EntityWrapper<KechengEntity>()
            ...
            .eq("shangke_address", kecheng.getShangkeAddress())
            ;
...
//                            kechengEntity.setShangkeTime(sdf.parse(data.get(0)));          //上课时间 要改的
//                            kechengEntity.setShangkeAddress(data.get(0));                    //上课地点 要改的
