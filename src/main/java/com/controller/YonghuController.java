...
//                            yonghuEntity.setYonghuUuidNumber(data.get(0));                    //学号 要改的
//                            yonghuEntity.setYonghuName(data.get(0));                    //学员姓名 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //学员手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //学员身份证号 要改的
